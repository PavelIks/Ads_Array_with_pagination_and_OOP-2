    ...
    <div class="main">
        ...
        $asoc =
            [
                ...
                4 => new Info("Смартфон Apple iPhone 5 16Gb neverlock плюс подарок", "Днепр, Чечеловский", date("j.n.Y h:m:s"),"https://ireland.apollo.olxcdn.com/v1/files/c2atrx0nyd8f-UA/image;s=644x461;r=270", "900 грн.", "true", "Продам телефон в хоршем качестве", 0), 5 => new Info("Iphone 7 plus 128k", "Днепр, Центральный", date("j.n.Y h:m:s"),"https://ireland.apollo.olxcdn.com/v1/files/420zwiwn45jt2-UA/image;s=644x461;r=90", "6 200 грн.", "false", "Новый телефон, практически не использовался", 0),
